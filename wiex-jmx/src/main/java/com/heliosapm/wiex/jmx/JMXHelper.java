...
/**
 * <p>Title: JMXHelper</p>
 * <p>Description: Static JMX helper functions</p> 
 * <p>Company: Helios Development Group LLC</p>
 * @author Whitehead (nwhitehead AT heliosdev DOT org)
 * <p><code>com.heliosapm.wiex.jmx.JMXHelper</code></p>
 */

public class JMXHelper {
	/** The property name where the jmx default domain is referenced */
	public static final String JMX_DOMAIN_PROPERTY = "wiex.jmx.comain";
	...
	public static MBeanServer getHeliosMBeanServer() {
		...
		String jmxDomain = getSystemThenEnvProperty(JMX_DOMAIN_PROPERTY, "jboss");
		if(jmxDomain!=null) {
	 ...
	 */
	public static String getSystemThenEnvProperty(String name, String defaultValue) {
	...
	public static Object getAttribute(MBeanServerConnection conn, String delimiter, ObjectName objectName, String...attrs) {
		try {
			if(objectName!=null && attrs!=null && attrs.length > 0) {
				...
				String key = fastConcatAndDelim(delimiter, attrs);
