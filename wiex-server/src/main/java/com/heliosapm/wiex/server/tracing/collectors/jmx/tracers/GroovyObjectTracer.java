...
import com.heliosapm.wiex.server.tracing.collectors.groovy.PreparedScript;
import com.heliosapm.wiex.server.tracing.collectors.jmx.AbstractObjectTracer;
import com.heliosapm.wiex.server.tracing.collectors.jmx.RenderedTrace;
...
public class GroovyObjectTracer extends AbstractObjectTracer {
	 ...
	 * @see com.heliosapm.wiex.server.collectors.jmx.ObjectTracer#renderTracingValue(java.lang.Object)
	 */
